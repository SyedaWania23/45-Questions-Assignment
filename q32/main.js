...
let current_users = ["rida", "Tabassum", "Zulaikha", "Shiza", "Ayeza", "Ali", "Hira"];
let new_users = ["rida", "Mina", "Iqra", "Sara"];
new_users.forEach(new_user => {
    let new_userLower = new_user.toLowerCase();
    let userName = current_users.some(current_user => current_user.toLowerCase() === new_userLower);
    if (userName) {
